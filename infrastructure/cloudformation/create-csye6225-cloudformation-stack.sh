...
jq '.Changes[0].ResourceRecordSet.ResourceRecords[0].Value = "'$PUBLIC_IP'"' /home/andy/Downloads/infrastructure/scripts/change-resource-record-sets.json > tmp.$$.json && mv tmp.$$.json //home/andy/Downloads/infrastructure/scripts/change-resource-record-sets.json

aws route53 change-resource-record-sets --hosted-zone-id Z17B5DKZJAGHZM
 --change-batch file:///home/andy/Downloads/infrastructure/scripts/change-resource-record-sets.json